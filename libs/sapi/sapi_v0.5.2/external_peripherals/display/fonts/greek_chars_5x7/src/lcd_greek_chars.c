...
#define GAMA_BITMAP \
    { ___XXXXX, ___X____, ___X____, ___X____, ___X____, ___X____, ___X____, }

#define DELTA_BITMAP \
    { _____X__, _____X__, ____X_X_, ____X_X_, ____X_X_, ___X___X, ___XXXXX, }

#define THITA_BITMAP \
    { ____XXX_, ___XX_XX, ___X___X, ___XXXXX, ___X___X, ___XX_XX, ____XXX_, }

#define LAMDA_BITMAP \
    { _____X__, _____X__, ____X_X_, ____X_X_, ____X_X_, ___X___X, ___X___X, }

#define KSI_BITMAP \
    { ___XXXXX, ________, ________, ____XXX_, ________, ________, ___XXXXX, }

#define PI_BITMAP \
    { ___XXXXX, ___X___X, ___X___X, ___X___X, ___X___X, ___X___X, ___X___X, }

#define SIGMA_BITMAP \
    { ___XXXXX, ____X___, _____X__, ______X_, _____X__, ____X___, ___XXXXX, }

#define FI_BITMAP \
    { _____X__, ____XXX_, ___X_X_X, ___X_X_X, ___X_X_X, ____XXX_, _____X__, }

#define PSI_BITMAP \
    { ___X___X, ___X_X_X, ___X_X_X, ___X_X_X, ____XXX_, _____X__, _____X__, }

#define OMEGA_BITMAP \
    { ____XXX_, ___X___X, ___X___X, ___X___X, ____X_X_, ____X_X_, ___XX_XX, }

#define NU_BITMAP \
    { ___X_XX_, ___XX__X, ___X___X, ___X___X, ___X___X, _______X, _______X, }
...
lcdCustomChar_t* greekChars[11] = {
    &gamaChar,  &deltaChar, &thitaChar, &lamdaChar, &ksiChar, &piChar,
    &sigmaChar, &fiChar,    &psiChar,   &omegaChar, &nuChar,
};
