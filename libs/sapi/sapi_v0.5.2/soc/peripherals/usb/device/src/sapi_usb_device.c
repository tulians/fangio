...
static ErrorCode_t usbDeviceLpcInit(USB_CORE_DESCS_T *desc, USBD_API_INIT_PARAM_T *usb_param);
...
bool_t usbDeviceInit(UsbSubClass_t subclass) {
    ...
    switch (subclass) {
        ...
        case USB_HID_KEYBOARD:
            ...
            ret = usbDeviceKeyboardInit(g_hUsb,
                                        (USB_INTERFACE_DESCRIPTOR *)&USB_FsConfigDescriptor[sizeof(
